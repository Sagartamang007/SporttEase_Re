...
<div class="container py-4">
    ...
    <div class="card card-custom shadow mb-4">
        <div class="card-header card-header-custom py-3">
            <h6 class="m-0 font-weight-bold">Update Team Member Information</h6>
        </div>
            ...
            <form action="{{ route('team.update', $team->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-4">
                            <label for="designation" class="form-label form-label-custom">Designation / Position</label>
                            <input
                                type="text"
                                id="designation"
                                name="designation"
                        ...
                        <div class="mb-4">
                            <label class="form-label form-label-custom">Profile Image</label>
                    ...
                    <div class="col-md-4">
                        <div class="text-center">
                            <label class="form-label form-label-custom">Current Image</label>
