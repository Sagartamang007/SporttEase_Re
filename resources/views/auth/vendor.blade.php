            ...
            <form method="POST" action="{{ route('vendorStore') }}">
                ...
                <div class="form-group mt-4">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" class="absolute transform -translate-y-1/2 text-gray-500" id="togglePassword" onclick="togglePasswordVisibility('password')" style="top: 20px;right:20px">
                ...
                <div class="form-group mt-4">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" class="absolute transform -translate-y-1/2 text-gray-500" id="toggleConfirmPassword" onclick="togglePasswordVisibility('password_confirmation')" style="top: 20px; right:20px">
